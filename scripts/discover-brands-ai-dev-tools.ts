/**
 * Discover brands for AI Development Tools sub-subcategories
 *
...
// Taxonomy IDs for the two sub-subcategories
const TAXONOMY_IDS = [
  "01KE8DQE1XGV216N48V8NCCCZA", // AI Application Builders
  "01KE7XX0WV2CPSGG476Z3HC8DE", // IDEs & AI IDEs
];

async function discoverBrandsForAIDevTools() {
  console.log("🚀 Brand Discovery Script for AI Development Tools Sub-subcategories\n");
...
discoverBrandsForAIDevTools().catch((error) => {
