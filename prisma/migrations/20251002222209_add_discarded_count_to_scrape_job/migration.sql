...
INSERT INTO "new_ScrapeJob" ("apify_run_id", "completed_at", "created_at", "deleted_at", "error_message", "id", "posts_count", "project_id", "scraper_id", "started_at", "status", "updated_at", "used_urls") SELECT "apify_run_id", "completed_at", "created_at", "deleted_at", "error_message", "id", "posts_count", "project_id", "scraper_id", "started_at", "status", "updated_at", "used_urls" FROM "ScrapeJob";
