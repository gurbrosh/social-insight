...
CREATE TABLE "PostNews" (
    ...
    "tags" TEXT,
    CONSTRAINT "PostNews_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "Project" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);

-- CreateIndex
CREATE INDEX "PostNews_project_id_idx" ON "PostNews"("project_id");

-- CreateIndex
CREATE INDEX "PostNews_deleted_at_idx" ON "PostNews"("deleted_at");

-- CreateIndex
CREATE INDEX "PostNews_date_range_start_idx" ON "PostNews"("date_range_start");

-- CreateIndex
CREATE INDEX "PostNews_importance_score_idx" ON "PostNews"("importance_score");

-- RedefineTables (Remove deprecated columns from ScrapeJob)
